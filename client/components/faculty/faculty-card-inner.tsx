  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 overflow-hidden rounded-[22px] border border-border bg-muted">
        ...
        <div className="absolute inset-0 bg-linear-to-t from-foreground/80 via-foreground/10 to-transparent opacity-70 transition-opacity group-hover:opacity-85" />

        <div className="absolute left-3 top-3">
          <span className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/20 bg-black/25 text-white shadow-sm backdrop-blur-md">
            <Sparkles className="h-4 w-4" />
          </span>
        </div>

        <div className="absolute bottom-3 left-3 right-3">
          <span className="line-clamp-1 inline-flex max-w-full rounded-full border border-background/20 bg-background/15 px-3 py-1 text-xs font-semibold text-background backdrop-blur-md">
            {designation}
          </span>
        </div>
      </div>
      ...
      <div className="relative z-10 px-2 pb-2 pt-4">
        ...
        <div className="mt-4 flex items-center justify-between gap-3">
          ...
          <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-border bg-muted text-primary transition-colors group-hover:border-primary group-hover:bg-primary group-hover:text-primary-foreground">
